...
public class VentanaPrincipal extends JFrame implements ActionListener {
    ...
    private void inicio() {
        ...
        anadir.addActionListener(this);  // Configura el ActionListener para el botón "Añadir"
    ...
    private void anadirPersona() {
        if (campoNombre.getText().isEmpty() || campoApellidos.getText().isEmpty() ||
            campoTelefono.getText().isEmpty() || campoDireccion.getText().isEmpty()) {
